        ...
        http
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers(WHITE_LIST_URL)
                                ...
                                .requestMatchers("/api/v1/user/**").hasAnyAuthority(UserRoles.ADMIN.getValue(), UserRoles.COURIER.getValue(), UserRoles.CUSTOMER.getValue(), UserRoles.OWNER.getValue(), UserRoles.RESTAURANT_WORKER.getValue())
                                .requestMatchers("/api/v1/completedOrders/**").hasAnyAuthority(UserRoles.COURIER.getValue(), UserRoles.ADMIN.getValue())
                                .requestMatchers("/api/v1/restaurant/**").hasAnyAuthority(UserRoles.OWNER.getValue(), UserRoles.ADMIN.getValue(), UserRoles.COURIER.getValue(), UserRoles.CUSTOMER.getValue())
